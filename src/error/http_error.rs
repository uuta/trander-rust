...
//     fn error_response(&self) -> HttpResponse {
//         match self.code {
//             ErrorCode::BadRequest => HttpResponse::BadRequest().json(&self.message),
//             ErrorCode::Unauthorized => HttpResponse::Unauthorized().json(&self.message),
//             ErrorCode::NotFound => HttpResponse::NotFound().json(&self.message),
//             ErrorCode::ApiRequestError => HttpResponse::InternalServerError().json(&self.message),
//             ErrorCode::OtherClientError => HttpResponse::BadRequest().json(&self.message),
//             ErrorCode::InternalServerError => {
//                 HttpResponse::InternalServerError().json(&self.message)
//             }
//         }
//     }
// }
